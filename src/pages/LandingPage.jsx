    ...
    <div className="relative bg-[#F8FAFC] text-slate-900 font-sans selection:bg-indigo-100 selection:text-indigo-700 overflow-hidden">
      ...
      <section className="relative z-10 pt-24 pb-20 lg:pt-32 container mx-auto px-6 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          {/* RIGHT: FLOATING 3D GLASS CARDS (Responsive & Safe) */}
          <div className="lg:w-1/2 w-full relative flex justify-center items-center py-10">
            ...
            <div className="relative w-full max-w-[500px] aspect-square">
              ...
              >
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Today, 24 Oct</p>
                  </div>
                ...
                <div className="flex justify-between items-center text-sm font-semibold text-slate-600 bg-white/50 p-4 rounded-2xl">
                  <span>Calories</span>
                  <span className="text-slate-900">1,240 / 2,000</span>
                </div>
              </motion.div>

              {/* 2. FLOATING CARD (Heart Rate) - Top Right */}
              <motion.div
                animate={{ y: [0, -15, 0] }}
                transition={{
                  duration: 6,
              ...
              {/* 3. FLOATING CARD (Sleep) - Bottom Left */}
              <motion.div
                animate={{ y: [0, 15, 0] }}
                transition={{
                  duration: 7,
              ...
              >
                ...
                <div className="text-xs font-medium bg-white/20 px-2 py-1 rounded-md inline-block">
                  Excellent
                </div>
              </motion.div>
            </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-20">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto text-lg">
              Your health isn't just one number. It's a complex system. We help
              you understand it.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1: The Big Graph */}
            <div className="md:col-span-2 bg-slate-50 p-8 rounded-[2rem] border border-slate-100 hover:shadow-xl transition-all duration-300 group">
              <div className="flex justify-between items-start mb-8">
                <div>
                  ...
                  <p className="text-slate-500 mt-2">
                    Track trends over time with medical-grade accuracy.
                  </p>
                </div>
                <button className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center group-hover:bg-indigo-600 group-hover:text-white transition-colors">
                  <ChevronRight size={20} />
                </button>
              </div>
              {/* Visual: Bars */}
              <div className="flex items-end gap-2 h-32 w-full mt-auto opacity-70">
                {[30, 45, 35, 60, 50, 80, 55, 70, 65, 90, 75, 60].map(
                  (h, i) => (
                    <motion.div
                      key={i}
                      initial={{ height: 0 }}
                      ...
                      className={`flex-1 rounded-t-lg ${
                        i === 9 ? "bg-indigo-500" : "bg-slate-200"
                      }`}
                    />
                  )
                )}
            ...
            {/* Feature 2: Nutrition */}
            <div className="bg-slate-900 text-white p-8 rounded-[2rem] hover:shadow-xl transition-all duration-300">
              <div className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center text-orange-400 mb-6">
                <Zap size={24} />
              </div>
              <h3 className="text-xl font-bold mb-2">Macro Tracking</h3>
              <p className="text-slate-400 text-sm mb-8">
                Log food and water seamlessly.
              </p>
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-slate-100 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-slate-500 text-sm mb-6">
                Hit your targets, build streaks.
              </p>
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-sm text-slate-700">
                  <CheckCircle2 size={18} className="text-green-500" /> 8,000
                  Steps
                </div>
                <div className="flex items-center gap-3 text-sm text-slate-700">
                  <CheckCircle2 size={18} className="text-green-500" /> 2,000
                  kcal Burn
                </div>
                <div className="flex items-center gap-3 text-sm text-slate-700">
                  <CheckCircle2 size={18} className="text-slate-300" /> 8h Sleep
                </div>
              </div>
            </div>

            {/* Feature 4: The Brain (Wide) */}
            <div className="md:col-span-2 bg-gradient-to-br from-indigo-600 to-blue-700 p-8 rounded-[2rem] text-white flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden group">
              {/* Background Pattern */}
              ...
              <div className="z-10">
                ...
                <p className="text-indigo-100 mt-2 max-w-sm">
                  Our AI analyzes your patterns to provide personalized
                  recommendations for better recovery.
                </p>
              </div>

              <div className="z-10 bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20 w-full md:w-64">
